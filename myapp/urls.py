...
urlpatterns = [
    path('', views.show_dialogues, name='home'),
    ...
    path('get-recent-messages/', views.get_recent_messages, name='get-recent-messages'),
    path('search-messages/', views.search_messages, name='search-messages'),  # New route for message search
]